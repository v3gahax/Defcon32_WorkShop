...
def handle_message(raw_message):
    ...
    try:
        ...
        logging.info(f"Patient Information: ID: {patient_id}, Name: {patient_name}, DOB: {date_of_birth}, Gender: {gender}, Address: {address}, Phone Numbers: {phone_numbers}, Death Indicator: {death_indicator}")
