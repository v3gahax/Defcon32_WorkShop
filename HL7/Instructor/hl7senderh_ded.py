...
if __name__ == "__main__":
    ...
    HOST = '172.16.49.131'  # or the server's IP address if different
    ...
    hl7_message = (
        ...
        "PID|1||566-554-3423^^^GHH^MR||EVERYMAN^ADAM^A||19800101|M|||2222 HOME STREET^^ANN ARBOR^MI^^USA||555-555-2004~444-333-222|||||||||||||||||Y|20202020\r"
